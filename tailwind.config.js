	...
	theme: {
		extend: {
			...
			animation:{
				...
				"mainOpacity" : "bodyOpacity 0.5s linear 1.5s forwards",
				"sideNav-0" : "sideNavAppear 0.5s ease-out 0.1s forwards",
				"sideNav-1" : "sideNavAppear 0.6s ease-out 0.2s forwards",
				"sideNav-2" : "sideNavAppear 0.7s ease-out 0.3s forwards",
			},
			zIndex:{
				'1' : '1',
				'2' : '2',
